...
//   return (
//     <div className="sm:h-[480px] sm:w-[400px] bg-white/10 backdrop-blur-md rounded-2xl  p-6 sm:p-8 text-white ">
//       <h2 className="text-4xl font-bold text-purple-300 text-center mb-2">
//         Contact Me
//       </h2>

//       {feedback && (
//         <div
//           className="mb-4 text-center font-semibold py-2 px-4 rounded-lg bg-opacity-90 transition-all duration-300 text-white"
//           style={{
...
//             className="w-full p-3 bg-white/20 text-white placeholder-purple-100 border border-white/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400"
//             required
//           />
//         </div>
...
const ContactForm = () => {
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md md:max-w-md lg:max-w-lg bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl text-white p-4 sm:p-6 sm:ml-25">
